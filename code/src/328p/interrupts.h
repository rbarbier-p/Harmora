 ...
 * 
 * Handles:
 * - GPIO expander interrupts (PCINT1/PCINT2) → sets flags for task processing
 ...
 * - PC3 (PCINT11) = EXP2_INTA (Expander 2, Port A)
 * - PD0 (PCINT16) = EXP2_INTB (Expander 2, Port B)
 ...
 * - PCINT2 (PD0): Pin change, sets g_exp2_interrupt flag
 * 
